...
def run_1g1p_reco_selection_cuts( eventTree, classificationThreshold,
                                  ...
                                  fiducialData, return_on_fail=True ):
    passes = True
    recoList = []
    recoTrackList = []
    recoProtonCount = 0
    ...
    recoPhotonInfo = reco_photon_def.getRecoPhotonList(eventTree, fiducialData, showerE_threshold, showerFromTrack_sizethreshold)
    recoList = [info['index'] for info in recoPhotonInfo]
    ...
    cuts_passed['recoPhotonInfo'] = recoPhotonInfo
    return passes, cuts_passed, recoList, recoTrackList, recoProtonCount
