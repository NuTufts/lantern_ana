...
if run_num == 1:
    ...
    if contained:
        xsecflux_file = f"{lantern_dir}/studies/xsecfluxsys/systematics_output_run1_march2026/PLACEHOLDER_output_xsecflux_tki_run1_march2026_contained.root"
        detsys_files  = [
            f"{lantern_dir}/studies/xsecfluxsys/PLACEHOLDER_detsys_run3b_contained_1mil.root",  # 7 params (using Run 3 detsys, contained)
            f"{lantern_dir}/studies/xsecfluxsys/PLACEHOLDER_detsys_cv500k_run3b_contained_CV.root",  # SCE + recomb2
        ]
    else:
...
if run_num == 3:
    ...
    if contained:
        xsecflux_file = f"{lantern_dir}/studies/xsecfluxsys/output_tki_run3b_1mil_xsecflux/PLACEHOLDER_output_xsecflux_tki_run3b_1mil_contained.root"
        detsys_files  = [
            f"{lantern_dir}/studies/xsecfluxsys/PLACEHOLDER_detsys_run3b_contained_1mil.root",  # 7 params (contained)
            f"{lantern_dir}/studies/xsecfluxsys/PLACEHOLDER_detsys_cv500k_run3b_contained_CV.root",  # SCE + recomb2 (contained)
        ]
    else:
