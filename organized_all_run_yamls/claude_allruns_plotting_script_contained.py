...
if run_num == 1:
    ...
    out_name    = f"{lantern_dir}/organized_all_run_yamls/plots_run1/tki_run1_contained_hists.root"
...
if run_num == 3:
    ...
    out_name    = f"{lantern_dir}/organized_all_run_yamls/plots_run3/tki_run3_contained_hists.root"
...
for var, nbins, xmin, xmax, htitle in vars:
    ...
    h_purity.SetTitle(f"{plot_title} (Contained);{xtitle};Purity / Efficiency")
