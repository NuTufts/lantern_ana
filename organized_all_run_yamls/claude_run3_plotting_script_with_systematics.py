...
if run_num == 1:
    ...
    out_name     = f"{lantern_dir}/organized_all_run_yamls/plots_run1/tki_run1_contained.root"
    # No systematics for Run 1
...
if run_num == 3:
    ...
    out_name     = f"{lantern_dir}/organized_all_run_yamls/plots_run3/tki_run3_contained_withsys.root"
    # Systematics
