...
if run_num == 1:
    ...
    files = {
        "numu_sig": f"{lantern_dir}/studies/numu_cc_tki/output_master_tki_run1/run1_bnb_nu_overlay_20260319_162746.root",
        "numu_bg":  f"{lantern_dir}/studies/numu_cc_tki/output_master_tki_run1/run1_bnb_nu_overlay_20260319_162746.root",
        "extbnb":   f"{lantern_dir}/studies/numu_cc_tki/output_master_tki_run1/run1_extbnb_mcc9_v29e_20260319_163100.root",
        "data":     f"{lantern_dir}/studies/numu_cc_tki/output_master_tki_run1/run1_data_bnb5e19_20260319_163137.root",
    }
    ...
    if contained:
        ...
        detsys_files  = [
            f"{lantern_dir}/studies/xsecfluxsys/detsys_run3b_1mil_mcc9_v29e_dl_run3b_bnb_nu_overlay_1mil.root",  # 7 params (uncontained)
            f"{lantern_dir}/studies/xsecfluxsys/detsys_cv500k_run3b_bnb_nu_overlay_500k_CV.root",                 # SCE + recomb2 (uncontained)
        ]
...
for var, nbins, xmin, xmax, htitle in vars:
    ...
    for ibin in range(0, h_total_mc.GetNbinsX() + 2):
        ...
        if short in xsecflux_hists:
            ...
            if short == 'muKE':  # DEBUG
                print(f"  ibin={ibin} bin_centre={bin_centre:.1f} xs_ibin={xs_ibin} cv_xs={cv_xs:.4f}")
            if cv_xs > 0:
