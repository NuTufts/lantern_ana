...
if run_num == 1: 
	...
	show_data = True 
	plot_title = "Run 1"
	out_name = f"{lantern_dir}/all_runs_plots/nue_hists1.root"
	remove_cut = ""
...
if run_num == 3: 
	...
	xsecflux_files = {
		"nue": f"{lantern_dir}/run3_mmr/root_files/xsecflux/run3b_nue_covar_nue.root",
		"numu": f"{lantern_dir}/run3_mmr/root_files/xsecflux/run3b_nue_covar_nu.root"
	}
	show_data = True 
	plot_title = "Run 3: CC Inclusive Nue"
	out_name = f"{lantern_dir}/all_runs_plots/nue_hists3b.root"
...
if run_num == 4: 
	...
	scaling = {"numu":targetpot/7.881656209241413e+20,
			...
			"data":1.0}
	files = {"numu": f"{lantern_dir}/zrun4b_mmr/nue_raw_root/run4b_v10_04_07_20_BNB_nu_overlay_retuple.root",
			"nue":f"{lantern_dir}/zrun4b_mmr/nue_raw_root/run4b_v10_04_07_09_BNB_nue_overlay_surprise.root", 
			"extbnb":f"{lantern_dir}/zrun4b_mmr/nue_raw_root/run4b_extbnb.root",
			"data":f"{lantern_dir}/zrun4b_mmr/nue_raw_root/run4b_beamon.root"}
	xsecflux_files = {
		"nue": f"{lantern_dir}/zrun4b_mmr/nue_xsecflux/xsecflux_run4b_v10_04_07_09_BNB_nue_overlay_surprise.root",
		"numu": f"{lantern_dir}/zrun4b_mmr/nue_xsecflux/xsecflux_run4b_v10_04_07_20_BNB_nu_overlay_retuple.root"
	}
	show_data = False 
	plot_title = "Run 4b"
	out_name = f"{lantern_dir}/all_runs_plots/nue_hists4.root"
	remove_cut = "&& (remove_true_nue_cc_flag==0)"
	xsecflux_variables = ['visible_energy', 'reco_neutrino_energy', 'reco_electron_energy', 'reco_cos_theta']
	var_name_map = {
	'neutrino_energy': 'reco_neutrino_energy',
	...
	xsecflux_sample_map = {
		'nue': 'run4b_v10_04_07_09_BNB_nue_overlay_surprise', # Not used, but keeping for consistency
		'numu': 'run4b_v10_04_07_20_BNB_nu_overlay_retuple'  
	}
