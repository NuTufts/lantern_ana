...
for dataset,dataset_config in data_config['datasets'].items():
  ...
  sampleDatasets[dataset] = SampleDataset.load_from_config( dataset_config, input_dir_list=input_dir_list )
  print("Opened dataset[",dataset,"]: nentries=",len(sampleDatasets[dataset]))
